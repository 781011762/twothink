...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '-?f"N4S^iI:(},a%;`62P#*wg@F<ML+~R=kZ9)3n', //默认数据加密KEY
	'data_cache_key'=> '-?f"N4S^iI:(},a%;`62P#*wg@F<ML+~R=kZ9)3n',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'-?f"N4S^iI:(},a%;`62P#*wg@F<ML+~R=kZ9)3n', //加密KEY
