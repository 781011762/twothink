<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\tt.com\public/../application/home/view/default/index\my.html";i:1507827975;s:66:"D:\tt.com\public/../application/home/view/default/base\common.html";i:1507827861;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="utf-8">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-3">
            <img src="__STATIC__/app/image/5.png" width="60" height="60" />
        </div>
        <div class="col-xs-9">
            ZhangSan<br/>
            北大花园小区<br/>
    ...
    <div>
        <ul class="list-group fuwuList">
            <li class="list-group-item"><a href="<?php echo url('index/diaochawenjuan'); ?>" class="text-danger"><span class="iconfont">&#xe60a;</span>我的缴费账单</a> </li>
