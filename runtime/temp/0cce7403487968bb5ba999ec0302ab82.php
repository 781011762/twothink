...
<div class="container-fluid">
    <div class="indexImg row">
        <img src="__STATIC__/app/image/index.png" width="100%" />
    </div>
    <div class="serviceList text-center">
        <div class="container">
            <div class="row">
                <div class="col-xs-4">
                    <a href="<?php echo url('index/article?change=inform'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('index/article?change=sever'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('member/online'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('index/rental'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('index/article?change=activity'); ?>">
